<!-- Modal -->
<div class="modal fade" id="edit-modal-brand" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div>
                    <form action="{{ route('brands.update') }}" method="POST" id="edit-cat-form">
                                    ...
                                    <div class="px-4 py-3 bg-white sm:p-6">
                                        <div class="grid grid-cols-6 gap-3">
                                            <div class=" col-span-6 sm:col-span-4">
                                                <label for="edit_brand_id"
                                                    class="block text-sm font-medium text-gray-700">Brand ID <span
                                                        class="text-red-600">*</span></label>
                                                <input type="text" name="brand_id" id="edit_brand_id" readonly required
                                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow sm:text-sm border-gray-300 rounded-md">
                                            </div>

                                            <div class=" col-span-6 sm:col-span-4">
                                                <label for="edit_brand_name"
                                            ...
                                            <div class="col-span-6 sm:col-span-4">
                                                <label for="edit_status"
                                                    class="block text-sm font-medium text-gray-700">Brand Status <span
                                                        class="text-red-600">*</span></label>
                        ...
                        <div div class="modal-footer">
                            ...
                            <button disabled id="edit_submit_brand" type="submit" class="btn btn-primary">Save
                                Changes</button>
                        </div>
                    </form>
