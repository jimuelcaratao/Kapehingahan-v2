<!-- Modal -->
<div class="modal fade" id="edit-modal-category" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div>
                    <form action="{{ route('categories.update') }}" method="POST" id="edit-cat-form">
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class=" col-span-6 sm:col-span-4">
                                                <label for="edit_category_id"
                                                    class="block text-sm font-medium text-gray-700">Category ID <span
                                                        class="text-red-600">*</span></label>
                                                <input type="text" name="category_id" id="edit_category_id" readonly
                                                    required
                                            ...
                                            <div class=" col-span-6 sm:col-span-4">
                                                <label for="edit_category_name"
                                                    class="block text-sm font-medium text-gray-700">Category name <span
                                                        class="text-red-600">*</span></label>
                        ...
                        <div div class="modal-footer">
                            ...
                            <button disabled id="edit_submit_category" type="submit" class="btn btn-primary">Save
                                Changes</button>
                        </div>
                    </form>
