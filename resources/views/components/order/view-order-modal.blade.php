<!-- Modal -->
<div class="modal fade" id="view-modal" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="view-modalLabel" aria-hidden="true">
