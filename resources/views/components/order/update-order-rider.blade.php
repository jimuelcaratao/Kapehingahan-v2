                                            ...
                                            <div class=" col-span-6 sm:col-span-4">
                                                <div class="form-check form-switch">
                                                    <input class="switches form-check-input" type="checkbox"
                                                        name="packaged_switch" id="packaged_switch">
                                                    <label class="form-check-label"
                                                        for="packaged_switch">Packaged</label>
                                                </div>
                                            </div>
                                            <div class=" col-span-6 sm:col-span-4">
                                                <div class="form-check form-switch">
                                                    <input class="switches form-check-input" type="checkbox"
                                                        name="shipped_switch" id="shipped_switch">
        ...
        $(document).ready(function() {
            ...
            $('#delivered_switch').change(function() {
                if ($('#delivered_switch').is(':checked')) {
                    if ($('#packaged_switch').prop('checked') == false || $('#shipped_switch').prop(
                            'checked') == false) {
                        alert("Need to check (Packaged and Shipping switches)?");
                        $(this).prop("checked", false);
                    }
                    if ($('#packaged_switch').prop('checked') == true && $('#shipped_switch').prop(
                            'checked') == true) {
                        var returnVal = confirm("Are you sure?");
                        $(this).prop("checked", returnVal);
                    }
