...
<style>
    ...
    <div class="relative min-h-screen flex ">
        <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
          <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-red-900 text-white bg-no-repeat bg-cover relative"
            ...
            <div class="w-full  max-w-md z-10">
              ...
              <div class="sm:text-sm xl:text-md text-gray-200 font-normal">KapeHingahan will start your day with a cup of coffee. Serving high-quality espresso-based drinks as well as delectable meals.</div>
            </div>
            <!---remove custom style-->
           <ul class="circles">
          <li></li>
             ...
             @endif
              ...
              <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div class="relative">
                    ...
                    <input
                      class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-[#7F4C1C]"
                      type="" placeholder="John doe" value="John doe">
                  </div>
                ...
                <div class="mt-8 content-center">
                  ...
                  <input
                    class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-[#7F4C1C]"
        ...
        'privacy_policy' => '<a target="_blank" href="' . route('policy.show') . '" class="underline text-sm text-gray-600 hover:text-gray-900">' . __('Privacy Policy') . '</a>',
                ...
                <div>
                  <button type="submit"
                    class="w-full flex justify-center bg-gradient-to-r from-[#4F3428] to-[#34221A]  hover:bg-gradient-to-l hover:from-[#4F3428] hover:to-[#34221A] text-gray-100 p-2 rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                    Sign in
                  </button>
                </div>
