        ...
        <div class="col-md-12">
            <div class="invoice">
                ...
                <div class="invoice-company text-inverse f-w-600">
                    <img class="main-logo" style="width: 140px; margin-left:0px; "
                        src="{{ asset('img/main-logo.png') }}">

                    <span class="pull-right hidden-print">
                        <a href="javascript:;" id="printPageButton" onclick="window.print()"
                            class="btn btn-sm btn-white m-b-10 p-l-5"><i class="fa fa-print t-plus-1 fa-fw fa-lg"></i>
                            Print</a>
                    </span>
                </div>
                ...
                <div class="invoice-header">
                    <div class="invoice-from">
                        ...
                        <address class="m-t-5 m-b-5">
                            <strong class="text-inverse">KapeHingahan Coffee Shop.</strong><br>
                            Bagong Silang<br>
                    ...
                    <div class="invoice-to">
                        ...
                        <address class="m-t-5 m-b-5">
                            ...
                            @if (!empty($order->user->user_address))
                                {{ $order->user->user_address->house }}, Barangay
                                {{ $order->user->user_address->barangay }},
                                {{ $order->user->user_address->province }}, {{ $order->user->user_address->city }}
                                <br>
                ...
                <div class="invoice-content">
                    ...
                    <div class="invoice-price">
                        ...
                        <div class="invoice-price-right">
                            <small class="total-price">TOTAL</small> <span class="f-w-600 total-price">₱
                                @convert($order->getTotalPrice())</span>
                        </div>
                    </div>
                    <!-- end invoice-price -->
                </div>
                ...
                <div class="invoice-footer">
                    ...
                    <p class="text-center">
                        ...
                        <span class="m-r-10"><i class="fa fa-fw fa-lg fa-envelope"></i>
                            weshop-computers@gmail.com</span>
                    </p>
                </div>
                <!-- end invoice-footer -->
            </div>
