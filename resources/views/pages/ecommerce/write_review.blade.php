                            ...
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                <div class="md:col-span-1">
                                    <div class="px-4 sm:px-0">
                                        <h3 class="text-lg font-medium leading-6 text-gray-900">Writing a Review on
                                ...
                                <div class="mt-5 md:mt-0 md:col-span-2">
                                    ...
                                    <form
                                        action="{{ route('write_review.write', [$product->product_code, $order->order_no]) }}"
                                        method="POST">
                                        @csrf
                                            ...
                                            <div class="px-4 py-5 bg-white sm:p-6">
                                                <div class="grid grid-cols-6 gap-6">
                                                    ...
                                                    <div class="col-span-6 sm:col-span-3">
                                                        <label for="stars"
                                                            class="block text-sm font-medium text-gray-700">Star</label>
                                                        <input type="text" name="stars" id="stars"
                                                            value="{{ old('stars') }}"
                                                            class="hidden mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        <div class="flex justify-center items-center">
                                                            <div class="flex items-center mt-2 mb-4">
                                                                <svg id="star-1"
                                                                    class="mx-1 cursor-pointer w-4 h-4 fill-current text-gray-400"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1">
                                                                <textarea id="body" name="body" rows="3"
                                                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('body') }}</textarea>
                                                            </div>
