    ...
    <div class="bg-white font-sans leading-normal tracking-normal">
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
                    <div class="relative flex flex-col justify-center">
                        ...
                        <div class="absolute mx-48 text-center">
                            <a href=#
                                class="text-white tracking-wide uppercase text-3xl font-bold transition duration-150 border-b-2 border-transparent hover:border-white">Hot
                                Brew</a>
                        </div>
                    </div>
                    <div class="relative flex flex-col justify-center">
                        ...
                        <div class="absolute mx-48 text-center">
                            <a href=#
                                class="text-white tracking-wide uppercase text-3xl font-bold transition duration-150 border-b-2 border-transparent hover:border-white">Cold
                                Brew</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex flex-col justify-center">
            <div class="relative m-3 flex flex-wrap mx-auto justify-center">
                                    ...
                                    <section class="container" id="slider">
                                        ...
                                        <div class="thumbnail">
                                            <div
                                                ...
                                                <div class="mt-10 pl-2 mb-2 flex justify-between ">
                                                    <div>
                                                        <p class="text-lg font-bold mb-0">Hot Butterbal Pumpkin <br />
                                                            Spice Latte</p>
                                                        <div class="flex item-center mt-2">
                ...
                <div class="slide-container">
                    <div id="slide-left" class="arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-yellow-900 hover:text-yellow-700"
