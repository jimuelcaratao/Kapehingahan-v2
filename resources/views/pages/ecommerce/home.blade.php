<x-ecommerce-layout>
                    ...
                    <div id="slider"
                        ...
                        <div class="flex flex-shrink-0 relative w-full sm:w-auto">
                            <img src="https://images.unsplash.com/photo-1561766926-a7c863179e15?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                                alt="coffee" class="object-cover object-center w-76 h-96 md:w-64 md:h-96 rounded-3xl" />
                        ...
                        <div class="flex flex-shrink-0 relative w-full sm:w-auto">
                            <img src="https://images.unsplash.com/photo-1620360289812-0abdae69d6d2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                                alt="coffee" class="object-cover object-center w-96 h-96 md:w-64 md:h-96 rounded-3xl" />
                            <div class="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6 rounded-3xl">
                                <div class="flex h-full items-end pb-6">
                                    <h3
                                        class="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white dark:text-gray-900">
                        ...
                        <div class="flex flex-shrink-0 relative w-full sm:w-auto">
                            <img src="https://images.unsplash.com/photo-1593231269103-6667d6905882?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=765&q=80 alt="
                                coffee" class="object-cover object-center w-96 h-96 md:w-64 md:h-96 rounded-3xl" />
                            <div class="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6 rounded-3xl">
                                <div class="flex h-full items-end pb-6">
                                    <h3
                                        class="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white dark:text-gray-900">
    ...
    5 - round($product_ave_reviews, 0),
                ...
                <div class="flex justify-center items-center">
                    ...
                    <div x-data="setup()">
                        <ul class="flex justify-center items-center my-8 gap-0 md:gap-4">
                            <template x-for="(tab, index) in tabs" :key="index">
                                <li class="cursor-pointer py-2 px-2 md:py-3 md:px-4 rounded-lg font-bold transition"
    ...
    5 - round($product_ave_reviews, 0),
                    ...
                    <div class="flex flex-row flex-wrap -mx-10">
                        ...
                        <div class="w-full md:w-1/2 mb-4 px-2">
                            <div class="flex flex-col sm:flex-row md:flex-col -mx-2">
                                <div
                                    class="w-full sm:w-1/2 md:w-full h-48 xl:h-64 mb-4 sm:mb-0 md:mb-4 px-2 overflow-hidden">
                                    <a class="block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover rounded-3xl hover:scale-110 transition duration-200"
                    ...
                    <div class="container m-auto px-6">
                        ...
                        <div class="lg:flex justify-between items-center">
                            <div class="lg:w-6/12 lg:p-0 p-7">
                                <h1 class="text-2xl md:text-4xl font-bold leading-tight mb-5 capitalize"> Feel the
                                    aroma at KapeHingahan Website! </h1>
                                <p class="text-xl"> KapeHingahan will start your day with a cup of coffee.
                                    Serving high-quality espresso-based drinks as well as delectable meals. </p>

                                <div class="py-5">
                                    <a href="#"
                                        class="text-white rounded-full py-2 px-5 text-lg font-semibold bg-[#4F3428] inline-block border mr-3">Order
                                        Now!</a>
                                </div>
                ...
                <div x-data="topBtn">
                    <button @click="scrolltoTop" id="topButton"
                        class="fixed z-10 hidden p-3 text-white bg-[#4F3428] rounded-full shadow-md bottom-10 right-10">
