        ...
        <div class="container p-16 mx-auto space-y-8">
            ...
            <div class="flex flex-col justify-center">
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
                    <div class="relative flex flex-col justify-center transform hover:scale-105 duration-300 ease-in-out">
                        <div aria-label="hot-brew">
                            <img alt="hot-brew" class="object-cover w-full h-60 rounded-3xl"
                                src={{ asset('img/hot-brew.jpg') }}>
                        </div>
                        <div class="absolute w-full text-center">
                            <a href=# class="text-white tracking-wide uppercase lg:text-3xl md:text-2xl font-bold hover:underline hover:border-white">Hot Brew</a>
                     </div>
                    </div>
                    <div class="relative flex flex-col justify-center transform hover:scale-105 duration-300 ease-in-out">
                        ...
                        <div class="absolute w-full text-center">
                            <a href=# class="text-white tracking-wide uppercase lg:text-3xl md:text-2xl font-bold hover:underline hover:border-white">Cold Brew</a>
                     </div>
                    </div>
                </div>
            </div>
