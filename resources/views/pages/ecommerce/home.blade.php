	  ...
	  <!--Slide 1-->
		...
		<ol class="carousel-indicators">
			<li class="inline-block mr-3">
				<label for="carousel-1" class="carousel-bullet cursor-pointer block text-4xl text-white hover:text-yellow-900">•</label>
			</li>
			<li class="inline-block mr-3">
				<label for="carousel-2" class="carousel-bullet cursor-pointer block text-4xl text-white hover:text-yellow-900">•</label>
			</li>
			<li class="inline-block mr-3">
				<label for="carousel-3" class="carousel-bullet cursor-pointer block text-4xl text-white hover:text-yellow-900">•</label>
			</li>
		</ol>
		...
		<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
			<article class="flex flex-col">
				<a href="#" aria-label="hot-brew">
					<img alt="" class="object-cover w-full h-60 rounded-3xl" src={{ asset('img/hot-brew.jpg') }}>
				</a>
			</article>

			<article class="flex flex-col">
				<a href="#" aria-label="cold-brew">
					<img alt="" class="object-cover w-full h-60 rounded-3xl" src={{ asset('img/cold-brew.jpg') }}>
				</a>
			</article>
		</div>
        </div>
...
<div class="flex flex-col justify-center">
    <div class="relative m-3 flex flex-wrap mx-auto justify-center">
      ...
      <div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-4 my-4 cursor-pointer">
        <div class="overflow-x-hidden rounded-2xl relative">
          ...
          <p class="absolute right-2 top-2 bg-yellow-900 rounded-full p-2 cursor-pointer group">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 group-hover:opacity-70" fill="none" viewBox="0 0 24 24" stroke="white">
  ...
  <!-- First ads -->
  <div class="mx-10">
      <img class="bg-cover h-80 w-full" src={{ asset('img/4.png') }} alt="ads">
  </div>
</x-ecommerce-layout>
