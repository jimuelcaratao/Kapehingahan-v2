<footer class="px-4 divide-y bg-black text-gray-300">
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/4 sm:grid-cols-3">
			<div class="space-y-3">
				...
				<ul class="space-y-1">
					<li>
						<a class = "hover:text-yellow-900" href="#">Home</a>
					</li>
					<li>
						<a class = "hover:text-yellow-900" href="#">Products</a>
					</li>
					<li>
						<a class = "hover:text-yellow-900" href="#">About</a>
					</li>
					<li>
						<a class = "hover:text-yellow-900" href="#">Contact</a>
					</li>
				</ul>
			</div>
			<div class="space-y-3">
				...
				<ul class="space-y-1">
					<li>
						<a class = "hover:text-yellow-900" href="#">Covid 19 Policy</a>
					</li>
					<li>
	...
	<div class="py-6 text-sm text-center dark:text-coolGray-400">Copyright © {{ date('Y') }} KapeHingahan</div>
</footer>
